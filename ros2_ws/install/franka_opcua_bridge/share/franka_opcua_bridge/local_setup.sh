...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/franka_opcua_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/franka_opcua_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/franka_opcua_bridge/environment/path.sh"
